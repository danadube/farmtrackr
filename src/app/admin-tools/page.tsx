        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 16 }}>
          <div style={card}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              <button 
                {...getPressHandlers('purgeContacts')}
                disabled={busy} 
                style={getPressStyle('purgeContacts', {
                  padding: '12px 16px',
                  borderRadius: 12,
                  border: 'none',
                ...
                onClick={() => run('Purge Contacts', '/api/admin/purge/contacts')}
              >
                Purge All Contacts
              </button>
              <button 
                {...getPressHandlers('purgeDocuments')}
                disabled={busy} 
                style={getPressStyle('purgeDocuments', {
                  padding: '12px 16px',
                  borderRadius: 12,
                  border: 'none',
                  cursor: busy ? 'not-allowed' : 'pointer',
                ...
                onClick={() => run('Purge Documents', '/api/admin/purge/documents')}
              >
                Purge All Documents
              </button>
              <button 
                {...getPressHandlers('purgeLetterheads')}
                disabled={busy} 
                style={getPressStyle('purgeLetterheads', {
                  padding: '12px 16px',
                  borderRadius: 12,
                  border: 'none',
                  cursor: busy ? 'not-allowed' : 'pointer',
                ...
                onClick={() => run('Purge Letterheads', '/api/admin/purge/letterheads')}
              >
                Purge All Letterheads
              </button>
              <button 
                {...getPressHandlers('purgeTransactions')}
                disabled={busy} 
                style={getPressStyle('purgeTransactions', {
                  padding: '12px 16px',
                  borderRadius: 12,
                  border: 'none',
                  cursor: busy ? 'not-allowed' : 'pointer',
                ...
                onClick={() => run('Purge Transactions', '/api/admin/purge/transactions')}
              >
