# FarmTrackr Documentation

This directory contains all documentation for the FarmTrackr web application.
...
- **Google OAuth Setup**: `google/GOOGLE_OAUTH_SETUP.md`
- **Deployment**: `setup/DEPLOYMENT_NOTES.md`
