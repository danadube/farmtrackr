...
- Xcode project with bundle identifier: `com.danadube.FarmTrackr`
...
1. **Bundle ID Mismatch**
   - Ensure Google Cloud Console bundle ID matches your app
   - Should be: `com.danadube.FarmTrackr`
...
1. **Incorrect Redirect URI**
   ...
   - Check GoogleSheetsConfig.swift
