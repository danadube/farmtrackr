...
│   └── *.html (brand HTML files)
│
├── status/                      # Project status
│   └── APP_ASSESSMENT.md
│
├── debug/                       # Debugging guides
│   ├── BRANDING_DEBUG_CHECKLIST.md
│   └── BRANDING_DEPLOYMENT_FIX.md
│
...
### Planning Documents
- **ROADMAP.md** (project root) - Current roadmap (most up-to-date planning) ⭐
...
- **Commission system?** → `docs/commission/`
- **Architecture & design?** → `docs/architecture/`
- **Planning features?** → `ROADMAP.md` (project root) or `docs/planning/`
