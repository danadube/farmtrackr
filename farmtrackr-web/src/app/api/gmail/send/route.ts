    ...
    const response = await fetch(webAppUrl, {
      ...
      body: JSON.stringify({
        ...
        emailData: {
          ...
          body: emailData.body,
          cc: emailData.options?.cc,
          bcc: emailData.options?.bcc,
          transactionId: emailData.options?.transactionId,
          contactId: emailData.options?.contactId,
          attachments: emailData.options?.attachments || emailData.attachments,
        },
      }),
    })
